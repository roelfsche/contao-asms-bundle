 ...
 */
$GLOBALS['TL_DCA']['tl_user']['palettes']['default'] = str_replace('email;', 'email;{job_offer_access_legend},job_offer_access;', $GLOBALS['TL_DCA']['tl_user']['palettes']['extend']);
...
$GLOBALS['TL_DCA']['tl_user']['palettes']['group'] = str_replace('email;', 'email;{job_offer_access_legend},job_offer_access;', $GLOBALS['TL_DCA']['tl_user']['palettes']['custom']);
